...
function ExtendableTextarea(props: Props, ref: ForwardedRef<Handle>) {
  ...
  return (
    <div className={style.component}>
      <textarea
        className={`${style.textarea} ${style.item}`}
        ref={textareaRef}
        style={{
          height: height,
        }}
      ...
      ></textarea>
      <span
        className={`${style.span} ${style.item}`}
        ref={spanRef}
        style={{
          width: width,
...
export default forwardRef<Handle, Props>(ExtendableTextarea);
