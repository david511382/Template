...
export class EditableUserProps extends OmitType(UserProps, [
  'id',
  'email',
  'utmCampaign',
  'utmMedium',
  ...
  constructor(partial?: Partial<EditableUserProps>) {
    super();
    if (partial) Object.assign(this, partial);
  }
}
...
export class User {
  ...
  constructor(
    ...
    this._props = new UserProps();
    if (partial) Object.assign(this._props, partial);
  }

  async setAsync(
    dto: Partial<EditableUserProps>,
  ...
  get utmCampaign(): string {
    return this._props.utmCampaign;
  }
  set utmCampaign(utmCampaign: string) {
    this._props.utmCampaign = utmCampaign;
  }
  ...
  get utmMedium(): string {
    return this._props.utmMedium;
  }
  set utmMedium(utmMedium: string) {
    this._props.utmMedium = utmMedium;
  }
  ...
  get utmSource(): string {
    return this._props.utmSource;
  }
  set utmSource(utmSource: string) {
    this._props.utmSource = utmSource;
  }
